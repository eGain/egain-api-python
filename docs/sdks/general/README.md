...
with Egain(
    ...
    res = egain.portal.general.get_my_portals(accept_language="en-US", language="en-US", department="service", filter_text="master", short_url_template="silver", order="asc", pagenum=1, pagesize=25)
...
| `order`                                                                                                                                              | [Optional[models.Order]](../../models/order.md)                                                                                                      | :heavy_minus_sign:                                                                                                                                   | Common query parameter $order.<br>_Default value_: asc                                                                                               | asc                                                                                                                                                  |
| `pagenum`                                                                                                                                            | *Optional[int]*                                                                                                                                      | :heavy_minus_sign:                                                                                                                                   | Pagination parameter that specifies the page number of results to be returned. Used in conjunction with $pagesize.                                   |                                                                                                                                                      |
