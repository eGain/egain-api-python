...
class PortalSuggestion(BaseSDK):
    ...
    def add_suggestion_comment(
        ...
        * The Suggestion must be in **Suggested** or **Pending** status, otherwise no comments can be added.
        ...
        request = models.AddSuggestionCommentRequest(
            accept_language=accept_language,
            portal_id=portal_id,
            suggestion_id=suggestion_id,
            create_comment=models.CreateComment(
                content=content,
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.create_comment, False, False, "json", models.CreateComment
            ),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="addSuggestionComment",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    async def add_suggestion_comment_async(
        self,
        *,
        accept_language: models.AcceptLanguage,
        portal_id: str,
